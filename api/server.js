...
const teacherRouter = require("./routers/teacher.router"); // ADDED: Teacher Router
...
app.use("/api/teacher", teacherRouter); // ADDED: Teacher Router Mounting
...
app.use('/uploads/teacher-images', express.static(path.join(__dirname, '..', 'frontend', 'public', 'images', 'uploaded', 'teacher'))); // ADDED: Teacher Images
